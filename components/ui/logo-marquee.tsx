/*
 * Logo marquee. Sourced from the 21st.dev registry (ddoemonn/logo-marquee),
 * retinted to this project's tokens. Chosen specifically because it honours
 * prefers-reduced-motion and pauses on hover AND keyboard focus, which the
 * cheaper marquees in the catalogue do not.
 */
"use client";
